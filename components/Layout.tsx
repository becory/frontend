...
export const Layout = (props: LayoutProps) => {
  ...
  return (
    <div className="flex w-full h-full flex-col">
      <div className="flex flex-none h-11 w-full bg-primary justify-center"></div>
      <div className="flex flex-none h-11 w-full bg-primary justify-between items-center content-center font-bold text-text--AAA">
      ...
      <main className="flex h-full flex-auto flex-col gap-3 overflow-y-auto">
        {children}
      </main>
    </div>
  );
